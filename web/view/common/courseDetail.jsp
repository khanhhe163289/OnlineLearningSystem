<%-- 
    ...
    Created on : Oct 4, 2022, 10:21:22 PM
    Author     : ADMIN
--%>
                    ...
                    <div class="container">
                        ...
                        <div class="header-main-wrapper">
                            ...
                            <div class="header-logo">
                                <a href="index.html"><img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="Logo"></a>
                            </div>
                            <!-- Header Logo End -->
                            ...
                            <div class="header-sign-in-up d-none d-lg-block">
                                <ul>
                                    <li><a class="sign-in" href="signin">Sign In</a></li>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="courses-details">
                                ...
                                <div class="courses-details-images">
                                    <img src="${pageContext.request.contextPath}/assets/images/courses/courses-details.jpg" alt="Courses Details">
                                    <span class="tags">${c.getCategory().getName()}</span>

                                    <div class="courses-play">
                                        <img src="${pageContext.request.contextPath}/assets/images/courses/circle-shape.png" alt="Play">
                                        <a class="play video-popup" href="https://www.youtube.com/watch?v=Wif4ZkwC0AM"><i class="flaticon-play"></i></a>
                                    </div>
                                </div>          
                                <h2 class="title">${c.getName()}</h2>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="instructors">
                                                ...
                                                <div class="tab-instructors">
                                                    ...
                                                    <div class="row">   
                                                        <c:forEach var="e" items="${c.getUsersTeach()}">
                                                            <div class="col-md-3 col-6">
                                                                <!-- Single Team Start -->
                                                                <div class="single-team">
                                                                    <div class="team-thumb">
                                                                        <c:choose>
                                                                            <c:when test="${e.getImage() == null}">
                                                                              <img src="${pageContext.request.contextPath}/assets/images/author/author-01.jpg" alt="Author">
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                              <img src="${pageContext.request.contextPath}/assets/images/author/${e.getImage()}" alt="Author">
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                        
                                                                    </div>
                                                                    <div class="team-content">
                                                                        <h4 class="name">${e.getFullName()}</h4>
                                                                    </div>
                                                                </div>
                                                                <!-- Single Team End -->
                                                            </div> 
...
<!--                                    <div class="info-price">
                                    ...
                                    <ul>
                                        ...
                                        <li><i class="icofont-ui-video-play"></i> <strong>Lessons</strong> <span>${lessons}</span></li>
                                        <li><i class="icofont-bars"></i> <strong>Enrolled Students</strong> <span>${c.getUsersRegister().size()}</span></li>
                                    ...
                                    <c:choose>
                                        <c:when test="${isEnrolled == true}">
                                            <span style="display: inline-block; color: #212832; font-size: 16px; font-weight: 500; margin:10px auto;">Valid to ${validTo}</span>
                                            <a href="enroll?courseId=${c.getId()}&&isEnrolled=${isEnrolled}" class="btn btn-primary btn-hover-dark" style="font-size: 14px; line-height: 30px; margin-left: 86px">Study</a>
                                        </c:when>
                                            <c:otherwise>
                                                <div class="info-price" style="margin-top: 24px;">
                                                    <span class="price">Price Package</span>
                                                </div>

                                                <ul>
                                                    <c:forEach var="p" items="${c.getPricePackages()}">
                                                        <c:if test="${p.isStatus() == true}">
                                                            <li><i class="icofont-price"></i> 
                                                                <strong>${p.getDuration()} Month(s)</strong> 
                                                                <p>
                                                                    <span style="text-decoration: line-through;">$ ${p.getListedPrice()}</span>
                                                                    <span">$ ${p.getSalePrice()}</span>
                                                                </p> 
                                                                <div class="info-btn">
                                                                    <a href="enroll?pricePackageId=${p.getId()}&courseId=${c.getId()}" class="btn btn-primary btn-hover-dark" style="font-size: 14px; line-height: 30px;">Enroll</a>
                                                                </div>
                                                            </li>
                                                        </c:if>
                                                    </c:forEach>
